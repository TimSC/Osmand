...
import com.kinatomicEsus.plus.activities.ShowRouteInfoActivity;
import com.kinatomicEsus.plus.routing.RouteDirectionInfo;
import com.kinatomicEsus.plus.routing.RoutingHelper;
import com.kinatomicEsus.plus.routing.RoutingHelper.IRouteInformationListener;
			...
			public void onClick(View v) {
				if(routingHelper.getRouteDirections() != null && directionInfo > 0){
					...
					if(routingHelper.getRouteDirections().size() > directionInfo){
						...
						com.kinatomicEsus.Location l = routingHelper.getLocationFromRouteDirection(info);
