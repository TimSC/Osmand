...
import com.kinatomicEsus.GeoidAltitudeCorrection;
import com.kinatomicEsus.PlatformUtil;
import com.kinatomicEsus.access.NavigationInfo;
import com.kinatomicEsus.binary.RouteDataObject;
import com.kinatomicEsus.data.LatLon;
import com.kinatomicEsus.plus.OsmandSettings.OsmandPreference;
...
public class OsmAndLocationProvider implements SensorEventListener {
	...
	public interface OsmAndLocationListener {
		void updateLocation(com.kinatomicEsus.Location location);
	}
	...
	public com.kinatomicEsus.Location getFirstTimeRunDefaultLocation() {
		...
		for (String provider : providers) {
			com.kinatomicEsus.Location location = convertLocation(service.getLastKnownLocation(provider), app);
			if (location != null) {
				return location;
			}
		}
	...
	// location not null!
	private void updateSpeedEmulator(com.kinatomicEsus.Location location) {
	...
	public static boolean isPointAccurateForRouting(com.kinatomicEsus.Location loc) {
	...
	private float calcGeoMagneticCorrection(float val) {
		if (previousCorrectionValue == 360 && getLastKnownLocation() != null) {
			com.kinatomicEsus.Location l = getLastKnownLocation();
...
//		}
	...
	private void updateLocation(com.kinatomicEsus.Location loc ) {
	...
	public static com.kinatomicEsus.Location convertLocation(Location l, OsmandApplication app) {
		if (l == null) {
			return null;
		}
		com.kinatomicEsus.Location r = new com.kinatomicEsus.Location(l.getProvider());
	...
	private void scheduleCheckIfGpsLost(com.kinatomicEsus.Location location) {
		...
		if (location != null) {
			...
			app.runMessageInUIThreadAndCancelPrevious(LOST_LOCATION_MSG_ID, new Runnable() {
				...
				@Override
				public void run() {
					com.kinatomicEsus.Location lastKnown = getLastKnownLocation();
	...
	public void setLocationFromService(com.kinatomicEsus.Location location, boolean continuous) {
	...
	public void setLocationFromSimulation(com.kinatomicEsus.Location location) {
		setLocation(location);
	}

	private void setLocation(com.kinatomicEsus.Location location) {
		if(location == null){
			updateGPSInfo(null);
		}
		...
		// 3. routing
		com.kinatomicEsus.Location updatedLocation = location;
	...
	private void enhanceLocation(com.kinatomicEsus.Location location) {
	...
	public void checkIfLastKnownLocationIsValid() {
		com.kinatomicEsus.Location loc = getLastKnownLocation();
	...
	public com.kinatomicEsus.Location getLastKnownLocation() {
		return location;
	}
