...
import com.kinatomicEsus.IProgress;
import com.kinatomicEsus.PlatformUtil;
import com.kinatomicEsus.access.AccessibilityPlugin;
import com.kinatomicEsus.plus.activities.LocalIndexInfo;
import com.kinatomicEsus.plus.activities.LocalIndexesActivity;
import com.kinatomicEsus.plus.activities.LocalIndexesActivity.LoadLocalIndexTask;
import com.kinatomicEsus.plus.activities.MapActivity;
import com.kinatomicEsus.plus.activities.SettingsActivity;
import com.kinatomicEsus.plus.audionotes.AudioVideoNotesPlugin;
import com.kinatomicEsus.plus.development.OsmandDevelopmentPlugin;
import com.kinatomicEsus.plus.distancecalculator.DistanceCalculatorPlugin;
import com.kinatomicEsus.plus.extrasettings.OsmandExtraSettings;
import com.kinatomicEsus.plus.monitoring.OsmandMonitoringPlugin;
import com.kinatomicEsus.plus.osmedit.OsmEditingPlugin;
import com.kinatomicEsus.plus.osmodroid.OsMoDroidPlugin;
import com.kinatomicEsus.plus.parkingpoint.ParkingPositionPlugin;
import com.kinatomicEsus.plus.rastermaps.OsmandRasterMapsPlugin;
import com.kinatomicEsus.plus.srtmplugin.SRTMPlugin;
...
public abstract class OsmandPlugin {
	...
	private static final String PARKING_PLUGIN_COMPONENT = "com.kinatomicEsus.parkingPlugin"; //$NON-NLS-1$
	private static final String SRTM_PLUGIN_COMPONENT_PAID = "com.kinatomicEsus.srtmPlugin.paid"; //$NON-NLS-1$
	private static final String SRTM_PLUGIN_COMPONENT = "com.kinatomicEsus.srtmPlugin"; //$NON-NLS-1$
