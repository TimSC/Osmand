...
import com.kinatomicEsus.plus.base.SuggestExternalDirectoryDialog;
import com.kinatomicEsus.plus.download.DownloadActivityType;
import com.kinatomicEsus.plus.download.DownloadEntry;
import com.kinatomicEsus.plus.download.DownloadIndexAdapter;
import com.kinatomicEsus.plus.download.DownloadIndexesThread;
import com.kinatomicEsus.plus.download.IndexItem;
import com.kinatomicEsus.plus.download.IndexItemCategory;
			...
			if (Version.isMarketEnabled(getMyApplication())) {
				msg.setNeutralButton(R.string.install_paid, new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(Version.marketPrefix(getMyApplication()) +  "com.kinatomicEsus.plus"));
						try {
