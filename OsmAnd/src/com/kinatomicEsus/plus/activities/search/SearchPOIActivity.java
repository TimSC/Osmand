 ...
 * 
 */
package com.kinatomicEsus.plus.activities.search;
...
import com.kinatomicEsus.access.NavigationInfo;
import com.kinatomicEsus.data.Amenity;
import com.kinatomicEsus.data.AmenityType;
import com.kinatomicEsus.data.LatLon;
import com.kinatomicEsus.plus.NameFinderPoiFilter;
import com.kinatomicEsus.plus.OsmAndFormatter;
import com.kinatomicEsus.plus.OsmAndLocationProvider.OsmAndCompassListener;
import com.kinatomicEsus.plus.OsmAndLocationProvider.OsmAndLocationListener;
...
import com.kinatomicEsus.plus.SearchByNameFilter;
import com.kinatomicEsus.plus.activities.EditPOIFilterActivity;
import com.kinatomicEsus.plus.activities.MapActivity;
import com.kinatomicEsus.plus.activities.MapActivityActions;
import com.kinatomicEsus.plus.activities.OsmandListActivity;
import com.kinatomicEsus.util.Algorithms;
import com.kinatomicEsus.util.OpeningHoursParser;
import com.kinatomicEsus.util.OpeningHoursParser.OpeningHours;
...
public class SearchPOIActivity extends OsmandListActivity implements OsmAndCompassListener, OsmAndLocationListener {
	...
	public static final String AMENITY_FILTER = "com.kinatomicEsus.amenity_filter"; //$NON-NLS-1$
	...
	private com.kinatomicEsus.Location location = null; 
	...
	protected void onResume() {
		...
		if(bundle.containsKey(SEARCH_LAT) && bundle.containsKey(SEARCH_LON)){
			location = new com.kinatomicEsus.Location("internal"); //$NON-NLS-1$
	...
	private void showPoiCategoriesByNameFilter(String query, com.kinatomicEsus.Location loc){
	...
	private com.kinatomicEsus.Location getSearchedLocation(){
	...
	@Override
	public void updateLocation(com.kinatomicEsus.Location location) {
		boolean handled = false;
		if (location != null && filter != null) {
			com.kinatomicEsus.Location searchedLocation = getSearchedLocation();
	...
	static class SearchAmenityRequest {
		...
		private int type;
		private com.kinatomicEsus.Location location;
		
		public static SearchAmenityRequest buildRequest(com.kinatomicEsus.Location l, int type){
	...
	class SearchAmenityTask extends AsyncTask<Void, Amenity, List<Amenity>> implements ResultMatcher<Amenity> {
		...
		com.kinatomicEsus.Location getSearchedLocation(){
	...
	class AmenityAdapter extends ArrayAdapter<Amenity> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			com.kinatomicEsus.Location loc = location;
			if(loc != null){
				mes = new float[2];
				LatLon l = amenity.getLocation();
				com.kinatomicEsus.Location.distanceBetween(l.getLatitude(), l.getLongitude(), loc.getLatitude(), loc.getLongitude(), mes);
			}
			int opened = -1;
			if (amenity.getOpeningHours() != null) {
