...
import com.kinatomicEsus.plus.OsmAndLocationProvider;
...
import com.kinatomicEsus.plus.activities.FavouritesListActivity;
import com.kinatomicEsus.plus.activities.FavouritesListFragment;
import com.kinatomicEsus.plus.activities.NavigatePointFragment;
...
public class SearchActivity extends SherlockFragmentActivity implements OsmAndLocationListener {
	...
	public static final String SEARCH_LAT = "com.kinatomicEsus.search_lat"; //$NON-NLS-1$
	public static final String SEARCH_LON = "com.kinatomicEsus.search_lon"; //$NON-NLS-1$
...
//		getSupportActionBar().setTitle(R.string.select_search_position);
		...
		Log.i("com.kinatomicEsus", "Start on create " + (System.currentTimeMillis() - t ));
			...
			public boolean onNavigationItemSelected(int position, long itemId) {
				if (position != 0) {
					if (position == POSITION_CURRENT_LOCATION) {
						com.kinatomicEsus.Location loc = getLocationProvider().getLastKnownLocation();
