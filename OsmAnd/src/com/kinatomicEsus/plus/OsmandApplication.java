...
import com.kinatomicEsus.data.FavouritePoint;
import com.kinatomicEsus.plus.GPXUtilities.GPXFile;
import com.kinatomicEsus.plus.GPXUtilities.WptPt;
import com.kinatomicEsus.plus.activities.DayNightHelper;
import com.kinatomicEsus.plus.activities.LiveMonitoringHelper;
import com.kinatomicEsus.plus.activities.OsmandIntents;
import com.kinatomicEsus.plus.activities.SavingTrackHelper;
...
import com.kinatomicEsus.plus.api.SQLiteAPIImpl;
...
import com.kinatomicEsus.plus.voice.CommandPlayer;
import com.kinatomicEsus.plus.voice.CommandPlayerException;
import com.kinatomicEsus.plus.voice.CommandPlayerFactory;
...
public class OsmandApplication extends Application implements ClientContext{
	...
	public void onCreate() {
		...
		settingsAPI = new com.kinatomicEsus.plus.api.SettingsAPIImpl(this);
		externalServiceAPI = new com.kinatomicEsus.plus.api.ExternalServiceAPIImpl(this);
		internalToDoAPI = new com.kinatomicEsus.plus.api.InternalToDoAPIImpl(this);
		internalOsmAndAPI = new com.kinatomicEsus.plus.api.InternalOsmAndAPIImpl(this);
