package com.kinatomicEsus.plus.base;

import com.kinatomicEsus.Location;
import com.kinatomicEsus.StateChangedListener;
import com.kinatomicEsus.map.IMapLocationListener;
...
public class MapViewTrackingUtilities implements OsmAndLocationListener, IMapLocationListener, OsmAndCompassListener {
	...
	private void registerUnregisterSensor(com.kinatomicEsus.Location location, boolean overruleRegister) {
		...
		if (mapView != null) {
			...
			if (!isMapLinkedToLocation()) {
				...
				if (locationProvider.getLastKnownLocation() != null) {
					com.kinatomicEsus.Location lastKnownLocation = locationProvider.getLastKnownLocation();
