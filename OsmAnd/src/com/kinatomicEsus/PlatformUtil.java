 ...
 * 		Logger.getLogger("com.kinatomicEsus").setLevel(Level.ALL);
...
public class PlatformUtil {
	public static String TAG = "com.kinatomicEsus"; //$NON-NLS-1$
...
//			return android.util.Log.isLoggable(TAG, android.util.Log.DEBUG);
	...
	public static com.kinatomicEsus.Collator primaryCollator(){
		final Collator instance = Collator.getInstance();
		instance.setStrength(Collator.PRIMARY);
		return new com.kinatomicEsus.Collator() {
