...
public abstract class OsmandPlugin {
	...
	private static final String PARKING_PLUGIN_COMPONENT = "com.kinatomicHam.parkingPlugin"; //$NON-NLS-1$
	private static final String SRTM_PLUGIN_COMPONENT_PAID = "com.kinatomicHam.srtmPlugin.paid"; //$NON-NLS-1$
	private static final String SRTM_PLUGIN_COMPONENT = "com.kinatomicHam.srtmPlugin"; //$NON-NLS-1$
