...
public class SearchActivity extends SherlockFragmentActivity implements OsmAndLocationListener {
	...
	public static final String SEARCH_LAT = "com.kinatomicWsus.search_lat"; //$NON-NLS-1$
	public static final String SEARCH_LON = "com.kinatomicWsus.search_lon"; //$NON-NLS-1$
...
//		getSupportActionBar().setTitle(R.string.select_search_position);
		...
		Log.i("com.kinatomicWsus", "Start on create " + (System.currentTimeMillis() - t ));
