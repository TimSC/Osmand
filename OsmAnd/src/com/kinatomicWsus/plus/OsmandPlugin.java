...
public abstract class OsmandPlugin {
	...
	private static final String PARKING_PLUGIN_COMPONENT = "com.kinatomicWsus.parkingPlugin"; //$NON-NLS-1$
	private static final String SRTM_PLUGIN_COMPONENT_PAID = "com.kinatomicWsus.srtmPlugin.paid"; //$NON-NLS-1$
	private static final String SRTM_PLUGIN_COMPONENT = "com.kinatomicWsus.srtmPlugin"; //$NON-NLS-1$
