...
import com.kinatomicSurrey.plus.activities.ShowRouteInfoActivity;
import com.kinatomicSurrey.plus.routing.RouteDirectionInfo;
import com.kinatomicSurrey.plus.routing.RoutingHelper;
import com.kinatomicSurrey.plus.routing.RoutingHelper.IRouteInformationListener;
			...
			public void onClick(View v) {
				if(routingHelper.getRouteDirections() != null && directionInfo > 0){
					...
					if(routingHelper.getRouteDirections().size() > directionInfo){
						...
						com.kinatomicSurrey.Location l = routingHelper.getLocationFromRouteDirection(info);
