package com.kinatomicSurrey.plus.base;

import com.kinatomicSurrey.Location;
import com.kinatomicSurrey.StateChangedListener;
import com.kinatomicSurrey.map.IMapLocationListener;
...
public class MapViewTrackingUtilities implements OsmAndLocationListener, IMapLocationListener, OsmAndCompassListener {
	...
	private void registerUnregisterSensor(com.kinatomicSurrey.Location location, boolean overruleRegister) {
		...
		if (mapView != null) {
			...
			if (!isMapLinkedToLocation()) {
				...
				if (locationProvider.getLastKnownLocation() != null) {
					com.kinatomicSurrey.Location lastKnownLocation = locationProvider.getLastKnownLocation();
