...
import com.kinatomicSurrey.plus.base.SuggestExternalDirectoryDialog;
import com.kinatomicSurrey.plus.download.DownloadActivityType;
import com.kinatomicSurrey.plus.download.DownloadEntry;
import com.kinatomicSurrey.plus.download.DownloadIndexAdapter;
import com.kinatomicSurrey.plus.download.DownloadIndexesThread;
import com.kinatomicSurrey.plus.download.IndexItem;
import com.kinatomicSurrey.plus.download.IndexItemCategory;
			...
			if (Version.isMarketEnabled(getMyApplication())) {
				msg.setNeutralButton(R.string.install_paid, new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(Version.marketPrefix(getMyApplication()) +  "com.kinatomicSurrey.plus"));
						try {
