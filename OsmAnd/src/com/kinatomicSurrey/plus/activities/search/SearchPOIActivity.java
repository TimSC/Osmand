 ...
 * 
 */
package com.kinatomicSurrey.plus.activities.search;
...
import com.kinatomicSurrey.access.AccessibleToast;
import com.kinatomicSurrey.access.NavigationInfo;
import com.kinatomicSurrey.data.Amenity;
import com.kinatomicSurrey.data.AmenityType;
import com.kinatomicSurrey.data.LatLon;
import com.kinatomicSurrey.plus.NameFinderPoiFilter;
import com.kinatomicSurrey.plus.OsmAndFormatter;
import com.kinatomicSurrey.plus.OsmAndLocationProvider.OsmAndCompassListener;
import com.kinatomicSurrey.plus.OsmAndLocationProvider.OsmAndLocationListener;
import com.kinatomicSurrey.plus.OsmandApplication;
import com.kinatomicSurrey.plus.OsmandSettings;
import com.kinatomicSurrey.plus.PoiFilter;
import com.kinatomicSurrey.plus.R;
import com.kinatomicSurrey.plus.SearchByNameFilter;
import com.kinatomicSurrey.plus.activities.EditPOIFilterActivity;
import com.kinatomicSurrey.plus.activities.MapActivity;
import com.kinatomicSurrey.plus.activities.MapActivityActions;
import com.kinatomicSurrey.plus.activities.OsmandListActivity;
import com.kinatomicSurrey.util.Algorithms;
import com.kinatomicSurrey.util.OpeningHoursParser;
import com.kinatomicSurrey.util.OpeningHoursParser.OpeningHours;
...
public class SearchPOIActivity extends OsmandListActivity implements OsmAndCompassListener, OsmAndLocationListener {
	...
	public static final String AMENITY_FILTER = "com.kinatomicSurrey.amenity_filter"; //$NON-NLS-1$
	...
	private com.kinatomicSurrey.Location location = null; 
	...
	protected void onResume() {
		...
		if(bundle.containsKey(SEARCH_LAT) && bundle.containsKey(SEARCH_LON)){
			location = new com.kinatomicSurrey.Location("internal"); //$NON-NLS-1$
	...
	private void showPoiCategoriesByNameFilter(String query, com.kinatomicSurrey.Location loc){
	...
	private com.kinatomicSurrey.Location getSearchedLocation(){
	...
	@Override
	public void updateLocation(com.kinatomicSurrey.Location location) {
		boolean handled = false;
		if (location != null && filter != null) {
			com.kinatomicSurrey.Location searchedLocation = getSearchedLocation();
	...
	static class SearchAmenityRequest {
		...
		private int type;
		private com.kinatomicSurrey.Location location;
		
		public static SearchAmenityRequest buildRequest(com.kinatomicSurrey.Location l, int type){
	...
	class SearchAmenityTask extends AsyncTask<Void, Amenity, List<Amenity>> implements ResultMatcher<Amenity> {
		...
		com.kinatomicSurrey.Location getSearchedLocation(){
	...
	class AmenityAdapter extends ArrayAdapter<Amenity> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			com.kinatomicSurrey.Location loc = location;
			if(loc != null){
				mes = new float[2];
				LatLon l = amenity.getLocation();
				com.kinatomicSurrey.Location.distanceBetween(l.getLatitude(), l.getLongitude(), loc.getLatitude(), loc.getLongitude(), mes);
			}
			int opened = -1;
			if (amenity.getOpeningHours() != null) {
