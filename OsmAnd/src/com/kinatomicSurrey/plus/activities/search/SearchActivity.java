...
import com.kinatomicSurrey.plus.activities.FavouritesListActivity;
import com.kinatomicSurrey.plus.activities.FavouritesListFragment;
import com.kinatomicSurrey.plus.activities.NavigatePointFragment;
...
public class SearchActivity extends SherlockFragmentActivity implements OsmAndLocationListener {
	...
	public static final String SEARCH_LAT = "com.kinatomicSurrey.search_lat"; //$NON-NLS-1$
	public static final String SEARCH_LON = "com.kinatomicSurrey.search_lon"; //$NON-NLS-1$
...
//		getSupportActionBar().setTitle(R.string.select_search_position);
		...
		Log.i("com.kinatomicSurrey", "Start on create " + (System.currentTimeMillis() - t ));
			...
			public boolean onNavigationItemSelected(int position, long itemId) {
				if (position != 0) {
					if (position == POSITION_CURRENT_LOCATION) {
						com.kinatomicSurrey.Location loc = getLocationProvider().getLastKnownLocation();
