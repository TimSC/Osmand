...
import com.kinatomicSurrey.data.FavouritePoint;
import com.kinatomicSurrey.plus.GPXUtilities.GPXFile;
import com.kinatomicSurrey.plus.GPXUtilities.WptPt;
import com.kinatomicSurrey.plus.activities.DayNightHelper;
import com.kinatomicSurrey.plus.activities.LiveMonitoringHelper;
import com.kinatomicSurrey.plus.activities.OsmandIntents;
import com.kinatomicSurrey.plus.activities.SavingTrackHelper;
...
import com.kinatomicSurrey.plus.api.SQLiteAPIImpl;
...
import com.kinatomicSurrey.plus.voice.CommandPlayer;
import com.kinatomicSurrey.plus.voice.CommandPlayerException;
import com.kinatomicSurrey.plus.voice.CommandPlayerFactory;
	...
	public void onCreate() {
		...
		if (Version.getAppName(this).equals("OsmAnd~")) {
			if (android.os.Build.VERSION.SDK_INT >= 9) {
				try {
					Class.forName("com.kinatomicSurrey.plus.base.EnableStrictMode").newInstance();
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
		...
		settingsAPI = new com.kinatomicSurrey.plus.api.SettingsAPIImpl(this);
		externalServiceAPI = new com.kinatomicSurrey.plus.api.ExternalServiceAPIImpl(this);
		internalToDoAPI = new com.kinatomicSurrey.plus.api.InternalToDoAPIImpl(this);
		internalOsmAndAPI = new com.kinatomicSurrey.plus.api.InternalOsmAndAPIImpl(this);
