package com.kinatomicSurrey.plus.parkingpoint;
		...
		TextInfoWidget parkingPlaceControl = new TextInfoWidget(map, 0, paintText, paintSubText) {
			...
			public boolean updateInfo(DrawSettings drawSettings) {
				...
				if( parkingPoint != null && !map.getRoutingHelper().isFollowingMode()) {
					...
					int d = 0;
					if (d == 0) {
						com.kinatomicSurrey.Location.distanceBetween(view.getLatitude(), view.getLongitude(), parkingPoint.getLatitude(), parkingPoint.getLongitude(), calculations);
