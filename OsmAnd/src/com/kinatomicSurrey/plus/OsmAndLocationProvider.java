...
import com.kinatomicSurrey.GeoidAltitudeCorrection;
import com.kinatomicSurrey.PlatformUtil;
import com.kinatomicSurrey.access.NavigationInfo;
import com.kinatomicSurrey.binary.RouteDataObject;
import com.kinatomicSurrey.data.LatLon;
import com.kinatomicSurrey.plus.OsmandSettings.OsmandPreference;
...
public class OsmAndLocationProvider implements SensorEventListener {
	...
	public interface OsmAndLocationListener {
		void updateLocation(com.kinatomicSurrey.Location location);
	}
	...
	public com.kinatomicSurrey.Location getFirstTimeRunDefaultLocation() {
		...
		for (String provider : providers) {
			com.kinatomicSurrey.Location location = convertLocation(service.getLastKnownLocation(provider), app);
			if (location != null) {
				return location;
			}
		}
	...
	// location not null!
	private void updateSpeedEmulator(com.kinatomicSurrey.Location location) {
	...
	public static boolean isPointAccurateForRouting(com.kinatomicSurrey.Location loc) {
	...
	private float calcGeoMagneticCorrection(float val) {
		if (previousCorrectionValue == 360 && getLastKnownLocation() != null) {
			com.kinatomicSurrey.Location l = getLastKnownLocation();
...
//		}
	...
	private void updateLocation(com.kinatomicSurrey.Location loc ) {
	...
	public static com.kinatomicSurrey.Location convertLocation(Location l, OsmandApplication app) {
		if (l == null) {
			return null;
		}
		com.kinatomicSurrey.Location r = new com.kinatomicSurrey.Location(l.getProvider());
	...
	private void scheduleCheckIfGpsLost(com.kinatomicSurrey.Location location) {
		...
		if (location != null) {
			...
			app.runMessageInUIThreadAndCancelPrevious(LOST_LOCATION_MSG_ID, new Runnable() {
				...
				@Override
				public void run() {
					com.kinatomicSurrey.Location lastKnown = getLastKnownLocation();
	...
	public void setLocationFromService(com.kinatomicSurrey.Location location, boolean continuous) {
	...
	public void setLocationFromSimulation(com.kinatomicSurrey.Location location) {
		setLocation(location);
	}

	private void setLocation(com.kinatomicSurrey.Location location) {
		if(location == null){
			updateGPSInfo(null);
		}
		...
		// 3. routing
		com.kinatomicSurrey.Location updatedLocation = location;
	...
	private void enhanceLocation(com.kinatomicSurrey.Location location) {
	...
	public void checkIfLastKnownLocationIsValid() {
		com.kinatomicSurrey.Location loc = getLastKnownLocation();
	...
	public com.kinatomicSurrey.Location getLastKnownLocation() {
		return location;
	}
