 ...
 * 		Logger.getLogger("com.kinatomicSurrey").setLevel(Level.ALL);
...
public class PlatformUtil {
	public static String TAG = "com.kinatomicSurrey"; //$NON-NLS-1$
...
//			return android.util.Log.isLoggable(TAG, android.util.Log.DEBUG);
	...
	public static com.kinatomicSurrey.Collator primaryCollator(){
		final Collator instance = Collator.getInstance();
		instance.setStrength(Collator.PRIMARY);
		return new com.kinatomicSurrey.Collator() {
