...
import net.recreationmap.plus.render.MapVectorLayer;
import net.recreationmap.plus.routing.RoutingHelper;
import net.recreationmap.plus.views.ContextMenuLayer;
import net.recreationmap.plus.views.FavoritesLayer;
import net.recreationmap.plus.views.GPXLayer;
import net.recreationmap.plus.views.MapControlsLayer;
...
import net.recreationmap.plus.views.POIMapLayer;
import net.recreationmap.plus.views.PointLocationLayer;
import net.recreationmap.plus.views.PointNavigationLayer;
import net.recreationmap.plus.views.RouteInfoLayer;
import net.recreationmap.plus.views.RouteLayer;
import net.recreationmap.plus.views.TransportInfoLayer;
import net.recreationmap.plus.views.TransportStopsLayer;
