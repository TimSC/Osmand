...
import net.recreationmap.plus.views.mapwidgets.BaseMapWidget;
import net.recreationmap.plus.views.mapwidgets.ImageViewWidget;
import net.recreationmap.plus.views.mapwidgets.MapInfoWidgetsFactory;
import net.recreationmap.plus.views.mapwidgets.MapInfoWidgetsFactory.TopTextView;
...
import net.recreationmap.plus.views.mapwidgets.NextTurnInfoWidget;
import net.recreationmap.plus.views.mapwidgets.RouteInfoWidgetsFactory;
import net.recreationmap.plus.views.mapwidgets.StackWidgetView;
import net.recreationmap.plus.views.mapwidgets.TextInfoWidget;
import net.recreationmap.plus.views.mapwidgets.UpdateableWidget;
