...
public class BinaryMapTransportReaderAdapter {
	...
	public com.kinatomicEsus.data.TransportRoute getTransportRoute(int filePointer, TIntObjectHashMap<String> stringTable,
		...
		com.kinatomicEsus.data.TransportRoute dataObject = new com.kinatomicEsus.data.TransportRoute();
		boolean end = false;
		long rid = 0;
		int rx = 0;
		int ry = 0;
	...
	protected void initializeNames(boolean onlyDescription, com.kinatomicEsus.data.TransportRoute dataObject,
