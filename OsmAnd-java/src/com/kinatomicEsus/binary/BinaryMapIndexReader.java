package com.kinatomicEsus.binary;
...
import com.kinatomicEsus.Collator;
import com.kinatomicEsus.CollatorStringMatcher;
import com.kinatomicEsus.CollatorStringMatcher.StringMatcherMode;
import com.kinatomicEsus.PlatformUtil;
import com.kinatomicEsus.ResultMatcher;
import com.kinatomicEsus.StringMatcher;
import com.kinatomicEsus.binary.BinaryMapAddressReaderAdapter.AddressRegion;
import com.kinatomicEsus.binary.BinaryMapAddressReaderAdapter.CitiesBlock;
import com.kinatomicEsus.binary.BinaryMapPoiReaderAdapter.PoiRegion;
import com.kinatomicEsus.binary.BinaryMapRouteReaderAdapter.RouteRegion;
import com.kinatomicEsus.binary.BinaryMapRouteReaderAdapter.RouteSubregion;
import com.kinatomicEsus.binary.BinaryMapTransportReaderAdapter.TransportIndex;
import com.kinatomicEsus.binary.OsmandOdb.MapDataBlock;
import com.kinatomicEsus.binary.OsmandOdb.OsmAndMapIndex.MapDataBox;
import com.kinatomicEsus.binary.OsmandOdb.OsmAndMapIndex.MapEncodingRule;
import com.kinatomicEsus.binary.OsmandOdb.OsmAndMapIndex.MapRootLevel;
import com.kinatomicEsus.data.Amenity;
import com.kinatomicEsus.data.AmenityType;
import com.kinatomicEsus.data.Building;
import com.kinatomicEsus.data.City;
import com.kinatomicEsus.data.LatLon;
import com.kinatomicEsus.data.MapObject;
import com.kinatomicEsus.data.Street;
import com.kinatomicEsus.data.TransportRoute;
import com.kinatomicEsus.data.TransportStop;
import com.kinatomicEsus.util.Algorithms;
import com.kinatomicEsus.util.MapUtils;
...
public class BinaryMapIndexReader {
	 ...
	 * Transport public methods
	 */
	public List<com.kinatomicEsus.data.TransportRoute> getTransportRouteDescriptions(TransportStop stop) throws IOException {
		TransportIndex ind = getTransportIndex(stop.getFileOffset());
		if(ind == null){
			return null;
		}
		List<com.kinatomicEsus.data.TransportRoute> list = new ArrayList<TransportRoute>();
		TIntObjectHashMap<String> stringTable = new TIntObjectHashMap<String>();
	...
	private static void testTransportSearch(BinaryMapIndexReader reader) throws IOException {
		...
		}
		{
			for (TransportStop s : reader.searchTransportIndex(buildSearchTransportRequest(sleft, sright, stop, sbottom, 15, null))) {
				...
				for (com.kinatomicEsus.data.TransportRoute route : routes.valueCollection()) {
