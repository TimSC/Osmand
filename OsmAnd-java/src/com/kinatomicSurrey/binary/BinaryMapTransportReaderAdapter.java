...
public class BinaryMapTransportReaderAdapter {
	...
	public com.kinatomicSurrey.data.TransportRoute getTransportRoute(int filePointer, TIntObjectHashMap<String> stringTable,
		...
		com.kinatomicSurrey.data.TransportRoute dataObject = new com.kinatomicSurrey.data.TransportRoute();
		boolean end = false;
		long rid = 0;
		int rx = 0;
		int ry = 0;
	...
	protected void initializeNames(boolean onlyDescription, com.kinatomicSurrey.data.TransportRoute dataObject,
