package com.kinatomicSurrey.binary;
...
import com.kinatomicSurrey.Collator;
import com.kinatomicSurrey.CollatorStringMatcher;
import com.kinatomicSurrey.CollatorStringMatcher.StringMatcherMode;
import com.kinatomicSurrey.PlatformUtil;
import com.kinatomicSurrey.ResultMatcher;
import com.kinatomicSurrey.StringMatcher;
import com.kinatomicSurrey.binary.BinaryMapAddressReaderAdapter.AddressRegion;
import com.kinatomicSurrey.binary.BinaryMapAddressReaderAdapter.CitiesBlock;
import com.kinatomicSurrey.binary.BinaryMapPoiReaderAdapter.PoiRegion;
import com.kinatomicSurrey.binary.BinaryMapRouteReaderAdapter.RouteRegion;
import com.kinatomicSurrey.binary.BinaryMapRouteReaderAdapter.RouteSubregion;
import com.kinatomicSurrey.binary.BinaryMapTransportReaderAdapter.TransportIndex;
import com.kinatomicSurrey.binary.OsmandOdb.MapDataBlock;
import com.kinatomicSurrey.binary.OsmandOdb.OsmAndMapIndex.MapDataBox;
import com.kinatomicSurrey.binary.OsmandOdb.OsmAndMapIndex.MapEncodingRule;
import com.kinatomicSurrey.binary.OsmandOdb.OsmAndMapIndex.MapRootLevel;
import com.kinatomicSurrey.data.Amenity;
import com.kinatomicSurrey.data.AmenityType;
import com.kinatomicSurrey.data.Building;
import com.kinatomicSurrey.data.City;
import com.kinatomicSurrey.data.LatLon;
import com.kinatomicSurrey.data.MapObject;
import com.kinatomicSurrey.data.Street;
import com.kinatomicSurrey.data.TransportRoute;
import com.kinatomicSurrey.data.TransportStop;
import com.kinatomicSurrey.util.Algorithms;
import com.kinatomicSurrey.util.MapUtils;
...
public class BinaryMapIndexReader {
	 ...
	 * Transport public methods
	 */
	public List<com.kinatomicSurrey.data.TransportRoute> getTransportRouteDescriptions(TransportStop stop) throws IOException {
		TransportIndex ind = getTransportIndex(stop.getFileOffset());
		if(ind == null){
			return null;
		}
		List<com.kinatomicSurrey.data.TransportRoute> list = new ArrayList<TransportRoute>();
		TIntObjectHashMap<String> stringTable = new TIntObjectHashMap<String>();
	...
	private static void testTransportSearch(BinaryMapIndexReader reader) throws IOException {
		...
		}
		{
			for (TransportStop s : reader.searchTransportIndex(buildSearchTransportRequest(sleft, sright, stop, sbottom, 15, null))) {
				...
				for (com.kinatomicSurrey.data.TransportRoute route : routes.valueCollection()) {
